...
class Bithumb(Plugin):
    def __init__(self, bot, channel, public_url="api.bithumb.com", currency=["BTC","ETH","DASH","LTC","ETC","XRP"], interval=60):
...
if __name__ == "__main__":
    inst = Bithumb(None,None,interval=10)
    inst.run()
